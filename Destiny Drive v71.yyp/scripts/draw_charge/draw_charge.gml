/// @description  draw_charge(x ,y ,value, max, colour, radius, transparency, width)
...
/// @param  transparency
/// @param  width
function draw_charge(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
